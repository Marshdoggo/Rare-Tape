    ...
    *,
    ...
    for _, item in source.iterrows():
        ...
        row = {
            ...
            "underlying_collectible": _blank_to_none(item.get("underlying_collectible")),
            "significance": _blank_to_none(item.get("significance")),
            "publisher": _blank_to_none(item.get("publisher")),
            "publication_year": _num(item.get("publication_year")),
            "issue_number": _num(item.get("issue_number")),
            "grade": _blank_to_none(item.get("grade")),
