# Rare Tape Asset Valuation Library
...
2. In Rare Tape, open `app/pages/8_Valuation_Library.py`, choose **Data Intake and Validation**, paste or upload both JSON blocks, validate, save, and run valuation.
...
5. Return to Rare Tape, use **Report Intake and Display**, paste or upload `report.md`, preview, and save.
